...
namespace Banco_Dados
{
    public partial class Form1 : Form
    {
        ...
        private void btnConectar_Click(object sender, EventArgs e)
        {
             ...
             * uma lista de opções e nesta nista deve aparecer o nome que escolhermos nas
             * proprieades/Settings do projeto anteriormente. No caso CS*/
            ...
            catch (Exception ex) 
            {
                 ...
                 * caso dê algum erro irá direto para o Catch e exibirá
                 * a msg de falha*/
            }
        }
